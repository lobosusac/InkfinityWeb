...
export function TeamCta() {
  return (
    <section id="equipos" className="relative overflow-hidden border-b border-line bg-surface/70 py-20 backdrop-blur sm:py-24">
      ...
      <Container className="relative grid gap-10 lg:grid-cols-[1.2fr_1fr] lg:items-center">
        <div>
          ...
          <p className="mt-5 max-w-xl text-lg leading-relaxed text-muted">
            Desde 10 piezas: tu logotipo, tus colores y el nombre de cada quien.
            Para gimnasios, boxes y equipos. Te mandamos el diseño para
          ...
          <ul className="mt-8 grid gap-2.5 text-sm text-muted sm:grid-cols-2">
            {[
              ...
              <li key={item} className="flex items-start gap-2.5">
                <span aria-hidden="true" className="mt-1.5 text-volt">
                  ◆
                </span>
                {item}
              </li>
